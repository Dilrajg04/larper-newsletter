...
buzzword:
  term: "Multimodal AI"
  definition: "An AI that can work with more than one type of input or output — not just text, but also images, audio, code, and more. Instead of needing a different tool for each task, a multimodal model handles them all in one place."
  examples:
    - "I uploaded a photo of my notes and asked GPT-5 to turn them into a study guide — it read the handwriting and formatted everything perfectly."
    - "The new model is multimodal, so it can look at your graph and explain what the data is actually saying."
    - "We used a multimodal AI to transcribe the lecture audio and then generate a summary with diagrams — no human editing needed."
---
